        ...
        <div className="text-center space-y-3 flex flex-col items-center">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-400 mt-1">
              Join <span className="bg-gradient-to-r from-violet-400 to-indigo-300 bg-clip-text text-transparent font-medium">onBoard</span> to manage issues, sprints, and teams
            </p>
          </div>
        </div>
